"""Checkpoint loading and preprocessor installation for LeRobot policies."""
...
def load_validated_policy_bundle(
    ...
    *,
...
) -> tuple[LeRobotPolicyBundle, CompatibilityReport]:
    ...
    from .features import install_native_resize_step, make_native_resize_step
