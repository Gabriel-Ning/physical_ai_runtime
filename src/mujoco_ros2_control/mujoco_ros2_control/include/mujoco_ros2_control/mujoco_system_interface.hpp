...
private:
  ...
  /**
   * @brief Callback run before every mj_step() on the physics thread.
   * Holds initial positions for any actuators that have not yet been claimed by controllers.
   */
  void pre_step_callback(mjData* data);
