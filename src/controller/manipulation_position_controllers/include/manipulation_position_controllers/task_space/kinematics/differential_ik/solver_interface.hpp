...
struct SolverConfig
{
  ...
  /// Fixed neutral joint positions in controller joint order. The OSQP
  /// backend uses these as a null-space posture target. Empty disables the
  /// neutral posture task.
